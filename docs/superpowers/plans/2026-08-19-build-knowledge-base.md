...
- [ ] **Step 1: Write the repository entry page**
...
- [ ] **Step 2: Write the positioning document**
...
- [ ] **Step 3: Verify navigation and scope language**
...
- [ ] **Step 4: Commit the entry and positioning documents**
...
- [ ] **Step 1: Write the job skill map**
...
- [ ] **Step 2: Write the Orin and software-stack map**
...
- [ ] **Step 3: Check required stack coverage**
...
- [ ] **Step 4: Commit the job and platform documents**
...
- [ ] **Step 1: Document the physical and host prerequisites**
...
- [ ] **Step 2: Document SDK Manager and post-flash verification**
...
- [ ] **Step 3: Define native and container learning tracks**
...
- [ ] **Step 4: Add component-specific setup boundaries**
...
- [ ] **Step 5: Add reproducibility and troubleshooting rules**
...
- [ ] **Step 6: Validate environment-guide coverage**
...
- [ ] **Step 7: Commit the environment guide**
...
- [ ] **Step 1: Write the CUDA and operator guide**
...
- [ ] **Step 2: Write the concurrency architecture**
...
- [ ] **Step 3: Define workload-specific metrics**
...
- [ ] **Step 4: Validate terminology and metrics**
...
- [ ] **Step 5: Commit optimization and concurrency documents**
...
- [ ] **Step 1: Write the four-to-five-month roadmap**
...
- [ ] **Step 2: Write the project blueprint**
...
- [ ] **Step 3: Define an experiment and acceptance matrix**
...
- [ ] **Step 4: Verify roadmap completeness**
...
- [ ] **Step 5: Commit the roadmap and project blueprint**
...
- [ ] **Step 1: Verify time-sensitive primary sources**
...
- [ ] **Step 3: Write the official-resource index**
...
- [ ] **Step 4: Check resource coverage and links**
...
- [ ] **Step 5: Commit the curated resources**
...
- [ ] **Step 1: Check file structure and internal links**
...
- [ ] **Step 2: Scan for unfinished markers and unsupported claims**

Run:

```bash
rg -n "T[O]DO|T[B]D|REPLACE_ME|占位文本|保证提升|生产级已完成" README.md docs references && exit 1 || true
rg -n "Orin 实测" README.md docs references
```
...
- [ ] **Step 3: Review the spec line by line**
